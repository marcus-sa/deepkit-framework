const metaFilePath = '.deepkit/meta.json'
const cacheFilePath = '.deepkit/cache';
...
export class External {
    ...
    public shouldInlineExternalLibraryImport(
        ...
        return true;
        // if (config.externalLibraryImports === true || config.externalLibraryImports?.types === true) return true;
        // const imports = config.externalLibraryImports?.types[resolvedModule.packageId.name];
